    ...
    <div>
      ...
      <a href="https://www.matchoffice.com" target="_blank" className='flex mb-6 items-start border-2 rounded p-4'>
        ...
        <div>
          ...
          <div className='flex md:flex-row italic '>
            <p className='mr-4 relative text-sm before:absolute before:bg-blue-500 before:h-1 before:w-1 before:rounded before:-right-2 before:top-2'>Ruby on Rails</p>
            <p className='mr-4 relative text-sm before:absolute before:bg-blue-500 before:h-1 before:w-1 before:rounded before:-right-2 before:top-2'>React</p>
          </div>
        </div>
      ...
      <a href="https://www.english-irream.com/" target="_blank" className='flex mb-6  items-start border-2 rounded p-4'>
        ...
        <div>
          ...
          <div className='flex md:flex-row italic '>
            <p className='mr-4 relative text-sm before:absolute before:bg-blue-500 before:h-1 before:w-1 before:rounded before:-right-2 before:top-2'>React</p>
            <p className='mr-4 relative text-sm before:absolute before:bg-blue-500 before:h-1 before:w-1 before:rounded before:-right-2 before:top-2'>AWS</p>
          </div>
        </div>
      </a>
