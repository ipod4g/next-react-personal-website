...
function Post(props) {
  ...
  return (
    <div className='relative'>
      ...
      <h2 className='font-bold text-2xl md:text-3xl tracking-tight mb-6 mt-2 text-title dark:text-gray-200'>{post.title}</h2>
        {/* <p>
