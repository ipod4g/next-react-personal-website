      ...
      <div className='flex md:w-3/4 flex-col'>
        ...
        <div className="flex mt-4">
          ...
          <a href="https://telegram.me/bezushko" target="_blank">
            <svg className='fill-icons h-6 w-6 mr-2 hover:fill-indigo-300' viewBox="0 0 32 32"><g id="icons"><g id="telegram"><path d="M21 12.1 13.2 19c-.1.1-.1.2-.1.3l-.3 2.7c0 .1-.1.1-.2 0l-1.2-4c-.1-.2 0-.4.2-.5l9.1-5.7c.3-.1.5.2.3.3z" class="st0"/>
            <path d="M16 2.2c-3.8 0-7.3 1.5-9.8 4-2.5 2.5-4.1 6-4.1 9.8 0 3.8 1.5 7.3 4.1 9.8 2.5 2.5 6 4 9.8 4 3.8 0 7.3-1.5 9.8-4 2.5-2.5 4.1-6 4.1-9.8C29.8 8.4 23.6 2.2 16 2.2zm8.2 7.9-2.8 13.6c-.1.6-.9.9-1.4.5L15.7 21l-2.2 2.2c-.4.4-1 .2-1.2-.3l-1.6-5-4.2-1.3c-.6-.2-.6-.9 0-1.1L23.2 9c.5-.1 1.2.4 1 1.1z" class="st0"/></g></g>
            </svg>
          </a>
        </div>
        </div>
